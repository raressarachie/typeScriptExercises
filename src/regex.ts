class regexValidators{
    ...
    public static validateDOB(dob: string) :boolean{
        ...
        let regDate =   new RegExp(`^(?:${year}-${month}-${day.charAt(0)}[1-${day}]|${year}-(?:02-(?:[12][0-9]|0[1-9])|0[46]-(?:30|[12][0-9]|0[1-9])|0[135]-(?:3[01]|[12][0-9]|0[1-9]))|(?:20${year.charAt(2)}[0-${year.charAt(3)}]|200[0-9]|19[0-9]{2})-(?:02-(?:[12][0-9]|0[1-9])|(?:0[469]|11)-(?:30|[12][0-9]|0[1-9])|(?:0[13578]|1[02])-(?:3[01]|[12][0-9]|0[1-9])))$`);
